...
class Pizza
{
  ...
  PizzaEnumsBox::Pineapple pineapple;
...
public:
  ...
  QString buildMessage()
  {
    ...
    switch (pineapple)
    {
      case PizzaEnumsBox::Yes_pineapple: {
        resultMessage += "С ананасами";
        break;
      }

      case PizzaEnumsBox::No_pineapple: {
...
public:
  ...
  void setPineapple(PizzaEnumsBox::Pineapple pineapple)
  {
    this->pineapple = pineapple;
  };
  Pizza build()
  {
    return Pizza(dough, typeOfPizza, olives, pepperoni, doubleCheese, pineapple);
  };
};
...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
  ...
  pineapple_radio_btn_group.addButton(ui->yes_pineapple, PizzaEnumsBox::Yes_pineapple);
  pineapple_radio_btn_group.addButton(ui->no_pineapple, PizzaEnumsBox::No_pineapple);
}
...
void MainWindow::on_makePizzaButton_clicked()
{
  ...
  pizzaBuilder.setPineapple(PizzaEnumsBox::Pineapple(pineapple_radio_btn_group.checkedId()));
